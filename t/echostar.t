...
# $Id: echostar.t,v 1.10 2006/04/24 21:53:06 Daddy Exp $
...
if (0)
  {
  # Sanity check for result_as_HTML:
  $WWW::Search::Test::oSearch->seek_result(1);
  ok(my $oResult = $WWW::Search::Test::oSearch->next_result);
  diag($WWW::Search::Test::oSearch->result_as_HTML($oResult));
  } # if
